...
calibrateDisplay = uicontrol('Parent',handles.hStatusPanel,'Style','Text','String','Calibration Status:','FontSize',12,'FontWeight','Bold',...
                        'BackgroundColor',handles.hStatusColor,'Position',[col2 row1 staticTextWidth textHeight]);
handles.calibrationText = uicontrol('Parent',handles.hStatusPanel,'Style','Edit','FontSize',12,'FontWeight','Bold',...
...
fileNameDisplay = uicontrol('Parent',handles.hStatusPanel,'Style','Text','String','File Name:','FontSize',12,'FontWeight','Bold',...
                        'BackgroundColor',handles.hStatusColor,'Position',[col2 row3 staticTextWidth textHeight]);
handles.fileNameText = uicontrol('Parent',handles.hStatusPanel,'Style','Edit','FontSize',12,'FontWeight','Bold',...
