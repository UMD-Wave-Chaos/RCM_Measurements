	...
	SVCXPRT *transp;
{
	...
	case create_link:
		...
		local = (char *(*)()) create_link_1_svc;
		break;

	case device_write:
		xdr_argument = xdr_Device_WriteParms;
		xdr_result = xdr_Device_WriteResp;
		local = (char *(*)()) device_write_1_svc;
		break;

	case device_read:
		xdr_argument = xdr_Device_ReadParms;
		xdr_result = xdr_Device_ReadResp;
		local = (char *(*)()) device_read_1_svc;
		break;

	case device_readstb:
		xdr_argument = xdr_Device_GenericParms;
		xdr_result = xdr_Device_ReadStbResp;
		local = (char *(*)()) device_readstb_1_svc;
		break;

	case device_trigger:
		xdr_argument = xdr_Device_GenericParms;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) device_trigger_1_svc;
		break;

	case device_clear:
		xdr_argument = xdr_Device_GenericParms;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) device_clear_1_svc;
		break;

	case device_remote:
		xdr_argument = xdr_Device_GenericParms;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) device_remote_1_svc;
		break;

	case device_local:
		xdr_argument = xdr_Device_GenericParms;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) device_local_1_svc;
		break;

	case device_lock:
		xdr_argument = xdr_Device_LockParms;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) device_lock_1_svc;
		break;

	case device_unlock:
		xdr_argument = xdr_Device_Link;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) device_unlock_1_svc;
		break;

	case device_enable_srq:
		xdr_argument = xdr_Device_EnableSrqParms;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) device_enable_srq_1_svc;
		break;

	case device_docmd:
		xdr_argument = xdr_Device_DocmdParms;
		xdr_result = xdr_Device_DocmdResp;
		local = (char *(*)()) device_docmd_1_svc;
		break;

	case destroy_link:
		xdr_argument = xdr_Device_Link;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) destroy_link_1_svc;
		break;

	case create_intr_chan:
		xdr_argument = xdr_Device_RemoteFunc;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) create_intr_chan_1_svc;
		break;

	case destroy_intr_chan:
		xdr_argument = xdr_void;
		xdr_result = xdr_Device_Error;
		local = (char *(*)()) destroy_intr_chan_1_svc;
		break;
	...
	SVCXPRT *transp;
{
	...
	case device_intr_srq:
		xdr_argument = xdr_Device_SrqParms;
		xdr_result = xdr_void;
		local = (char *(*)()) device_intr_srq_1_svc;
		break;
...
char *argv[];
{
	...
	if (getsockname(0, (struct sockaddr *)&saddr, &asize) == 0) {
		...
		_rpcpmstart = 1;
		proto = 0;
		openlog("vxi11", LOG_PID, LOG_DAEMON);
	} else {
#ifndef RPC_SVC_FG
		int size;
		int pid, i;
