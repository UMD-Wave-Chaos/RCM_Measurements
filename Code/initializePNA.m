function initializePNA(obj1,meas_name,cal_name,NOP)
%initializePNA(obj1,meas_name,cal_name,NOP)
%Inputs:
% obj1 - GPIB object connected to the PNA
% meas_name: vector of strings containing the measurement traces for the 4
% S parameters
% cal_name: name of the last calibration file
% NOP: number of measurement points to use
%This function initializes the PNA and gets everything ready to read
