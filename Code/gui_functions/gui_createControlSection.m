...
handles.measAnalyzeConfigButton = uicontrol('Parent',handles.hControlPanel,'Style','pushbutton','String','Measure/Analyze','FontSize',12,'FontWeight','Bold',...
                            'Position',[col1+buffer row5 buttonWidth buttonHeight]);