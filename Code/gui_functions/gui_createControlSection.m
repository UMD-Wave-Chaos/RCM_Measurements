...
handles.measureButton = uicontrol('Parent',handles.hControlPanel,'Style','pushbutton','String','Take Measurement','FontSize',12,'FontWeight','Bold',...
                            'Position',[col1+buffer row1 buttonWidth buttonHeight]);
handles.calibrateButton = uicontrol('Parent',handles.hControlPanel,'Style','pushbutton','String','Manual Calibration','FontSize',12,'FontWeight','Bold',...
