...
fprintf(obj1, 'calc:par:def "test1", S22'); %defines calc<#>:par:def's name as test
fprintf(obj1, 'calc:par:sel "test1"');
fprintf(obj1, 'DISPlay:WINDow1:TRACe1:FEED "test1"');
fprintf(obj1, 'DISP:WIND:Y:AUTO'); % Autoscale

fprintf(obj1, 'calc:par:def "test2", S21'); %defines calc<#>:par:def's name as test
fprintf(obj1, 'calc:par:sel "test2"');
fprintf(obj1, 'DISPlay:WINDow2:TRACe1:FEED "test2"');
fprintf(obj1, 'DISP:WIND:Y:AUTO'); % Autoscale

fprintf(obj1, 'calc:par:def "test3", S12'); %defines calc<#>:par:def's name as test
fprintf(obj1, 'calc:par:sel "test3"');
fprintf(obj1, 'DISPlay:WINDow3:TRACe1:FEED "test3"');
fprintf(obj1, 'DISP:WIND:Y:AUTO'); % Autoscale

fprintf(obj1, 'calc:par:def "test4", S11'); %defines calc<#>:par:def's name as test
fprintf(obj1, 'calc:par:sel "test4"');
fprintf(obj1, 'DISPlay:WINDow4:TRACe1:FEED "test4"');
fprintf(obj1, 'DISP:WIND:Y:AUTO'); % Autoscale

fprintf(obj1, 'SENSe:CORRection:COLL:Meth SPARSOLT'); %Run 2port calibration
